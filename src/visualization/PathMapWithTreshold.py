...
def main(dir):
    ...
    def folium_map():
        ...
        thresholds = [10, 25, 50, 75, 100, 150, 200, 250, 300, 400, 500, 600, 700, 800, 900, 1000, 1250, 1500]

        for i, t in enumerate(thresholds):
            upper = thresholds[i + 1] if i < len(thresholds) - 1 else None
            paths = unique_paths(t)
            ...
            delta_lat = (max_lon - min_lon) / map_overlay.shape[1] * map_overlay.shape[0] * np.cos(
                min_lat / 360 * 2 * np.pi)
        ...
        folium_map.save(dir + r"\images\sites\BikePathsMapTreshold.html")
        return folium_map
    ...
    def image_save(map):
        ...
        # write to a png file
        pathImage = dir + r"\images\final\BikePathsMapTreshold.png"
